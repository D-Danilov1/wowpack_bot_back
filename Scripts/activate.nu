...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Andrey\Drive\Projects\Python\NotificatorBot'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Andrey\Google Диск\Projects\Python\NotificatorBot\Scripts\deactivate.nu'
